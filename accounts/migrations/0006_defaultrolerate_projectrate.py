...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0005_adminsettings_url_domain_value_id'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Стандартная ставка')),
            ],
        ),
        migrations.CreateModel(
            name='ProjectRate',
            fields=[
                ...
                ('role_name', models.CharField(max_length=100, verbose_name='Название роли')),
                ('rate', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Почасовая ставка')),
            ],
            options={
